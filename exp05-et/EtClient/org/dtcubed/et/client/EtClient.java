...
// import org.dtcubed.et.clientservercommon.MessageInterface;
...
public class EtClient {
	...
	// private static String account = "household";               // For portability between MSFT and UNIX, all lower-case.
	...
	private static String note = "Maximum of 255 characters";    // Maximum: 255 characters. Disallow any downstream delimiters.
    	...
    	do {
    		...
    		try {
    			...
    			switch(inputChar) {
    				...
    				case 's':
    				case 'S':
    					System.out.print("Submit this Expense");
    					break;
					default:
						break;
    			}
